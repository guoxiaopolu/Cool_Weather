...
public class ChooseAreaActivity extends Activity {
	...
	/*
	 * 查询选中的省的所有的市，优先从数据库查询，数据库没有则到服务器查询
	 */
	...
	/*
	 * 查询选中的市的所有县，优先从数据库查询，数据库没有则到服务器查询
	 */
	...
	/*
	 * 捕获back按键，根据当前的级别来判断当前应返回省列表或市列表，或是退出
	 */
	@Override
